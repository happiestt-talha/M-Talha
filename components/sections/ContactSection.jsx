          ...
          <div className="lg:col-span-7">
            <div className="glass gold-violet-border rounded-3xl p-6">
              ...
              >
                ...
                <button
                  type="submit"
                  className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-2xl border border-[#C9A84C]/30 bg-[#0A0A0F]/40 px-5 text-sm font-semibold text-foreground shadow-[0_0_24px_rgba(201,168,76,0.10)]"
                >
                ...
                <p className="text-xs text-muted-foreground">
                  This form opens your email client via <span className="font-mono">mailto:</span>.
                  For a production API submission, we can wire up a server action or a provider.
                </p>
              </form>
            </div>
          </div>
